...
@echo on
%SPOON_START_OPTION% "%_PENTAHO_JAVA%" %OPT% -Xdebug -Xrunjdwp:transport=dt_socket,suspend=n,server=y,address=1234 -jar launcher\launcher.jar -lib ..\%LIBSPATH% %_cmdline%
@echo off
